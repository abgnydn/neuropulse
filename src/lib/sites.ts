...
export const SITES = {
  kernelfusion: {
    ...
    tagline: "Single-kernel fusion — 2,865× on Apple Silicon, 623× on phones.",
    shortDesc:
      "The research line. Two published preprints, one npm SDK, 592 real devices tested. The theory that all the applied projects build on.",
    category: "Theory",
    badge: "research",
    githubRepo: "https://github.com/abgnydn/kernelfusion",
    stats: [
      { value: "2,865×", label: "Apple Silicon avg" },
      { value: "623×", label: "Android avg" },
      { value: "592", label: "devices tested" },
    ],
  ...
  gpubench: {
    ...
    shortDesc:
      "Open WebGPU compute benchmarks on 592 real devices — Rastrigin, N-body, Monte Carlo Pi, RL environments. Every result published, no cherry-picking.",
    category: "Benchmarks",
    badge: "companion",
    githubRepo: "https://github.com/abgnydn/gpubench",
    stats: [
      { value: "592", label: "devices tested" },
      { value: "170", label: "transformer runs" },
